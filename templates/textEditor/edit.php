...
<?= $this->Form->create(null, ['url' => ['controller' => 'textEditor', 'action' => 'modify'],'type' => 'post']) ?> 
        ...
        <?= $this->Form->control('loc', [
            ...
            'class' => 'form-control',
            'id' => 'installation',
            'default' => $contract['loc_id']
        ]) ?>
        
        <label>Gouvernorat</label>
        <?= $this->Form->control('gouv', ['label' => false, 'value' => $location_load['gouvernorat'], 'type' => 'text', 'required' => true, 'disabled' => true]) ?>

        <label>Poids d'ascenseur</label>
        <?= $this->Form->control('poids', ['label' => false, 'value' => $contract['poids_assenseur'], 'type' => 'number', 'required' => true]) ?>
