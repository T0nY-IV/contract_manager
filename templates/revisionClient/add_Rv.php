...
<body>
<?= $this->Form->create(null, ['url' => ['controller' => 'revisionClient', 'action' => 'add'],'type' => 'post']) ?> 
        ...
        <?= $this->Form->control('poids', ['label' => false, 'type' => 'number', 'required' => true, 'id' => 'gouv']) ?>

        <label>Date</label>
        <?= $this->Form->control('date', ['label' => false, 'type' => 'date', 'required' => true]) ?> 
        
        <label>ingenieur</label>
        <?= $this->Form->control('ing', ['label' => false, 'type' => 'text', 'required' => true]) ?>
        
        <label>nombre de stop</label>
        <?= $this->Form->control('nb_stop', ['label' => false, 'type' => 'number', 'required' => true]) ?>
        
        <label>marque</label>
        <?= $this->Form->control('mark', ['label' => false, 'type' => 'text', 'required' => true]) ?>

        <label>type d'ascenceur</label>
        <?= $this->Form->control('typ', ['label' => false, 'type' => 'text', 'required' => true]) ?>

        
        <label>type de revision</label>
        <?= $this->Form->control('typ_rev', ['label' => false, 'type' => 'text', 'required' => true]) ?>

        <label>numéro d'ascenceur</label>
        <?= $this->Form->control('num_asc', ['label' => false, 'type' => 'number', 'required' => true]) ?>
